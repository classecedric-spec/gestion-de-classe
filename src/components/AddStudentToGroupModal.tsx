...
const AddStudentToGroupModal: React.FC<AddStudentToGroupModalProps> = ({ showModal, handleCloseModal, groupId, groupName, onAdded }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Although UI filters them, double safety
