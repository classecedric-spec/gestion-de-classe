...
const PresenceStudentCard = ({ student, currentStatus, isOverlay = false, disabled = false }) => {
    ...
    return (
        ...
        // Use inline style for dynamic border color if passed, but for now kept simple
        >
            {/* Avatar */}
            <div className={clsx(
...
export default PresenceStudentCard;
