...
const AddStudentToClassModal: React.FC<AddStudentToClassModalProps> = ({ showModal, handleCloseModal, classId, className, onAdded }) => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Manual casting for join results consistency
    ...
    const filteredStudents = students.filter(student => {
        ...
        // Check if ANY of the student's group matches selected filters
        // If selectedGroups is empty, it matches (unless we were forcing match ALL, but UI implies ANY)
