 ...
 * Le même composant existe déjà dans `src/components/Loading/index.tsx` mais certains imports
 * pointent directement vers `PageLoader`. Ce fichier garantit que le module existe et
