...
/**
 * @component Badge
 * @description Composant pour afficher des étiquettes, des tags et des indicateurs d'état avec différents styles (plein, contour, fantôme).
 * @param {BadgeProps} props - Propriétés du badge incluant variant, size, style, icon, dot, et removable.
 * @example
