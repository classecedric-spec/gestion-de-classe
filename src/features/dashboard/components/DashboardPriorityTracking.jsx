...
const DashboardPriorityTracking = ({ priorityData, onStudentClick }) => {

    // Helper sub-component for list items
    const StudentListItem = ({ student, badgeColor, badgeText, hoverContent }) => (
        <div
    ...
    const DailyStatsTable = ({ stats, label }) => (
        <>
