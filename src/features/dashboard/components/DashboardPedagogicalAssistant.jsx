...
import { LEVEL_COLORS } from '../hooks/useDashboardData';

const DashboardPedagogicalAssistant = ({
    branchStats,
    suggestions,
    yesterdayAbsentees,
    lastActiveLabel,
            ...
            {yesterdayAbsentees && yesterdayAbsentees.length > 0 && (
                <section className="bg-surface p-6 rounded-2xl border border-white/5 h-fit mt-6">
                    <h2 className="text-lg font-bold text-text-main flex items-center gap-3 mb-6">
                        <Users className="text-danger w-5 h-5" /> Absentéisme ({lastActiveLabel || 'Hier'})
                    </h2>
