...
import ProgressionCell from './desktop/ProgressionCell';
...
const TrackingDashboard = ({ timer, setTimer, timerFinished, setTimerFinished }) => {
    // Timer integration
    ...
    // Random Picker Modal
    const [isRandomPickerOpen, setIsRandomPickerOpen] = React.useState(false);
