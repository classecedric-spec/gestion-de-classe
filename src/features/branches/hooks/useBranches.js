...
export const useBranches = () => {
    ...
    // Fetch SubBranches
    const fetchSubBranches = useCallback(async (branchId) => {
        if (!branchId) {
            setSubBranches([]);
            return;
        }
    ...
    const reorderBranches = async (newBranches) => {
        setBranches(newBranches);
        try {
    ...
    const reorderSubBranches = async (newSubBranches) => {
    ...
    return {
        ...
        reorderBranches,
        reorderSubBranches,
        refreshSubBranches: () => selectedBranch && fetchSubBranches(selectedBranch.id)
    };
};
