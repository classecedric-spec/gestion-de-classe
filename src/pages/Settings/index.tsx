...
const Settings: React.FC = () => {
    ...
    }, [activeTab, cacheEnabled, loadSyncStats, fetchBulkData, loadCacheStats]);
                                            ...
                                            <ImageUpload
                                                ...
                                                onChange={(v) => {
                                                    if (v.startsWith('http')) {
                                                        setProfile(prev => ({ ...prev, photo_url: v, photo_base64: '' }));
                                                    } else {
                                                        setProfile(prev => ({ ...prev, photo_base64: v, photo_url: '' }));
                                                    }
                                                }}
