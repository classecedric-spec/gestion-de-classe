...
import { getSyncStats, clearAllSyncData } from '../../../lib/deltaSync';
...
export const useCacheSettings = () => {
    ...
    const handleToggleCache = useCallback((enabled) => {
    ...
    const handleBulkAdjustIndices = useCallback(async (delta) => {
        if (!selectedBulkBranch) {
            toast.error("Veuillez sélectionner une branche");
            return;
        }
