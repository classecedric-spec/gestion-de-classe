...
import { ChevronDown, ChevronUp, School, Dices, RefreshCw } from 'lucide-react';
...
export default function ClassroomTracking() {
    ...
    const { students, loading } = useHomeworkTracking(selectedGroup?.id || null, selectedDate, 'classe');
                ...
                <div className="flex items-center justify-between gap-4 mb-4">
                    <div>
                        ...
                        <p className="text-sm text-grey-medium mt-1">
                            Consultez les travaux planifiés par les élèves en classe
                        </p>
                    </div>
                    ...
                    {!selectedGroup ? (
                        <div className="py-12 bg-background/30 rounded-2xl border border-white/5 text-center">
                            ...
                            <p className="text-grey-medium">
                                Sélectionnez un groupe pour voir les travaux en classe.
                            </p>
                        </div>
                    ) : loading ? (
                        ...
                        <div className="py-12 bg-background/30 rounded-2xl border border-white/5 text-center px-4">
                            <p className="text-grey-medium">
                                Aucun travail en classe n'est planifié pour ce groupe à la date du <span className="text-white font-medium">{format(selectedDate, 'EEEE d MMMM yyyy', { locale: fr })}</span>.
                            </p>
                        </div>
                    ) : (
                        <>
