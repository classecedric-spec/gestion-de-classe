...
import { useGroupPdfGenerator } from '../../features/dashboard/hooks/useGroupPdfGenerator.jsx';
...
const Home = () => {
    ...
    const handleStudentClick = (student, tab = 'suivi') => {
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                ...
                                <div className="p-6 bg-surface/50 border border-white/5 rounded-3xl">
                                    ...
                                    <p className="text-3xl font-black text-white">{dashboardData.stats?.presentToday || 0}</p>
