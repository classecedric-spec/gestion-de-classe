                        ...
                        <div className="p-8 border-b border-white/5 bg-surface/20 flex justify-between items-start">
                            <div className="flex gap-6 items-center flex-1 min-w-0">
                                <div className={clsx(
                                    ...
                                    (selectedGroup.photo_url || selectedGroup.photo_base64) ? "bg-[#D9B981]" : "bg-surface"
                                )}>
                                    {(selectedGroup.photo_url || selectedGroup.photo_base64) ? (
                                        <img src={selectedGroup.photo_url || selectedGroup.photo_base64} alt="Group" className="w-[90%] h-[90%] object-contain" />
                                    ) : (
                                                ...
                                                <div key={student.id} className="relative group/card">
                                                    ...
                                                    >
                                                        <div className={clsx(
                                                            ...
                                                            (student.photo_url || student.photo_base64) ? "bg-[#D9B981]" : "bg-background"
                                                        )}>
                                                            {(student.photo_url || student.photo_base64) ? (
                                                                <img src={student.photo_url || student.photo_base64} alt="Student" className="w-[90%] h-[90%] object-contain" />
                                                            ) : (
