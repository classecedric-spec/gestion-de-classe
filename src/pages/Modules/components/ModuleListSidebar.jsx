...
ModuleListSidebar.propTypes = {
    ...
    subBranchFilter: PropTypes.string.isRequired,
    setSubBranchFilter: PropTypes.func.isRequired,
    availableBranches: PropTypes.array.isRequired,
    availableSubBranches: PropTypes.array.isRequired,
