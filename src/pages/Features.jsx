            ...
            <main className="max-w-7xl mx-auto px-6 py-24">
                ...
                <div className="mt-32 relative">
                    <div className="bg-gradient-to-br from-primary to-primary-dark p-12 md:p-20 rounded-[3rem] text-center shadow-2xl relative overflow-hidden">
                        ...
                        <Link to="/login" className="inline-flex items-center gap-3 bg-text-dark text-primary font-black py-5 px-12 rounded-full hover:scale-105 transition-all shadow-xl text-xs uppercase tracking-widest relative z-10">
