...
import { useStudentsAndActivities } from './hooks/useStudentsAndActivities';
...
const AvancementAteliers = () => {
    ...
    const { generatingPDF, handleGeneratePDF } = useAvancementPDF();
                                                    ...
                                                    <div className="w-full h-[52px] flex items-center justify-center">
                                                        {isAllowed ? (
                                                            <div className={clsx(
                                                                ...
                                                                {(() => {
                                                                    const IconComponent = getStatusIcon(displayStatus);
