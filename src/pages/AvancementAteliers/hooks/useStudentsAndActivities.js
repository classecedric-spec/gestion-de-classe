 ...
 */
export const useStudentsAndActivities = (selectedGroupId, selectedModuleId, selectedDateFin, selectedBrancheId, getFilteredModules) => {
    ...
    const fetchActivitiesAndProgress = useCallback(async (moduleIds) => {
        setLoading(true);
        try {
